            ...
            <main class="text-center ">
                <div class="head-title">
                    ...
                    <div class="table-data" id="pedidosActivos">
                        <div class="order">
                            <!-- Leyenda de estados de factura -->
                            <div class="d-flex justify-content-center mb-4 gap-5">
                                <div class="d-flex align-items-center">
                                    <ion-icon name="document-sharp" class="me-2 text-success" size="small"></ion-icon>
                                    <span>Factura Realizada</span>
                                </div>
                                <div class="d-flex align-items-center">
                                    <ion-icon name="document-sharp" class="me-2 text-secondary" size="small"></ion-icon>
                                    <span>Factura Sin Realizar</span>
                                </div>
                                <div class="d-flex align-items-center">
                                    <ion-icon name="document-sharp" class="me-2 text-danger" size="small"></ion-icon>
                                    <span>Error al Facturar</span>
                                </div>
                            </div>
