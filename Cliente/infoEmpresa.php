...
<div class="">
    ...
    <!-- CONTENT -->
    <!-- Seccion de información de empresa -->
    <section id="content">
        <div id="seccionInfo">
                    ...
                    <div class="order">
                        ...
                        <form onsubmit="return validateForm()">
                            <div class="form-row">
                                ...
                                <input class="input-small" type="numer" name="noEmpresa" id="noEmpresa" value=""
                                       readonly>
                            </div>
                        ...
                        <form id="formFacturacion" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="file" class="form-control form-control-sm" id="cerFile" name="cerFile"
                                           accept=".cer">
                                    <small id="cerFileName" class="form-text text-muted"></small>
                                </div>
                                <div class="col-md-4">
                                    <label for="permFile" class="form-label">Archivo KEY *</label>
                                    <input type="file" class="form-control form-control-sm" id="permFile"
                                           name="permFile" accept=".key">
                                    <small id="permFileName" class="form-text text-muted"></small>
                                </div>

                                <div class="col-md-4">
                                    <label for="keyPassword" class="form-label">Contraseña CSD *</label>
                                    <input type="password" class="form-control form-control-sm " id="keyPassword"
                                           name="keyPassword">
                                    <br>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="estadoCsd"
                                           name="estadoCsd" readonly1 tabindex="-1">
                                </div>
                                <div class="col-md-4">
                                    <label for="fechaInicioCsd" class="form-label">Fecha de Inicio del CSD</label>
                                    <input type="text" class="form-control form-control-sm" id="fechaInicioCsd"
                                           name="fechaInicioCsd" readonly1 tabindex="-1">
                                </div>
                                <div class="col-md-4">
                                    <label for="fechaVencimientoCsd" class="form-label">Vencimiento del CSD</label>
                                    <input type="text" class="form-control form-control-sm" id="fechaVencimientoCsd"
                                           name="fechaVencimientoCsd" readonly1 tabindex="-1">
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <form onsubmit="return validateForm()">
                ...
                <div class="form-row">
                    <label for="numExterior">Num. Exterior:</label>
                    <input class="input-small" type="text" name="numExteriorModal" id="numExteriorModal"
                           placeholder="Num. Exterior">
                    <label for="numInterior">Num. Interior:</label>
                    <input class="input-small" type="text" name="numInteriorModal" id="numInteriorModal"
                           placeholder="Num. Interior">
                    <label for="entreCalle">Entre Calle:</label>
                    <input class="input-m" type="text" name="entreCalleModal" id="entreCalleModal"
                           placeholder="Entre Calle">
                </div>
                ...
                <div class="form-row">
                    ...
                    <label for="referencia">Referencia:</label>
                    <input class="input-m" type="text" name="referenciaModal" id="referenciaModal"
                           placeholder="Referencia">
                </div>
                ...
                <div class="form-row">
                    ...
                    <label for="municipio">Municipio:</label>
                    <input class="input-m" type="text" name="municipioModal" id="municipioModal"
                           placeholder="Municipio">
                </div>
                ...
                <div class="form-row">
                    <!-- <a class='bx bx-message-rounded-error'></a> -->
                    <label for="cp">Codigo Postal: <a class='bx'> *</a></label>
                    <input class="input-m" type="text" name="codigoPostalModal" id="codigoPostalModal"
                           placeholder="Codigo Postal">
                </div>

                <div class="form-row">
                    <label for="poblacion">Población:</label>
                    <input class="input-m" type="text" name="poblacionModal" id="poblacionModal"
                           placeholder="Poblacion">
                </div>
