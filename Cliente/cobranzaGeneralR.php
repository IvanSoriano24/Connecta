            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="" href="Reportes.php">Cobranza General</a>
                        </li>
                    </ul>
                </div>

                <!-- INFO CLIENTE -->
                <div id="infoCliente" class="info-cliente-card mb-4" style="margin:0 !important; display: none">
                    ...
                    <div class="order" style="overflow: visible">
                        ...
                        <div class="head">
                            <div class="input-group">
                                <label for="filtroFechaInicio" style="margin-right: 20px">Fecha Inicio: </label>
                            ...
                            <div class="input-group">
                                <label for="filtroFechaFin" style="margin-right: 30px">Fecha Fin: </label>
...
<script src="JS/cobranzaGeneralR.js?n=1"></script>
<script>
