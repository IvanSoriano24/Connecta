    ...
    <section id="content">
        ...
        <main class="text-center">
            <div class="head-title">
                <div class="left">
                    <h1>Estados de Cuenta Detallado</h1>
                    <ul class="breadcrumb">
                        <li>
                            <a href="#">Inicio</a>
                        </li>
                        ...
                        <li>
                            <a class="" href="Reportes.php">Estados de Cuenta Detallado</a>
                        </li>
                    </ul>
                </div>
...
<script src="../../../../Users/Servidor/IdeaProjects/MDConnecta/Cliente/JS/estadosCuentasDetalladoR.js"></script>
<script>
